...
import { Post, Creator, Chat, SlideDeck } from "@/types";
...
import LiveSlideCall from "./components/LiveSlideCall";
    ...
    const fetchData = async () => {
      try {
        ...
        if (slug !== "-1") {
          ...
          const response = await fetch(`/api/slide-decks/by-slug/${slug}`);
          if (!response.ok) {
