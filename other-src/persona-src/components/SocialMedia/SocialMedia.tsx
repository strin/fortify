  ...
  return (
    <>
      <div className="flex justify-center mt-4 space-x-4 mb-4">
        <TrackedLink
          href="https://shi.ai/linkedin"
          target="_blank"
          className="text-gray-800 hover:text-blue-600 transition-colors duration-300"
          onClick={() => {
            Mixpanel.track("SocialLink", {
              name: "LinkedIn",
              url: "https://shi.ai/linkedin",
            });
          }}
        >
          <svg
        ...
        <TrackedLink
          href="mailto:tim@shi.ai"
          className="text-gray-800 hover:text-gray-600 transition-colors duration-300"
          onClick={() => {
            Mixpanel.track("SocialLink", {
              name: "Email",
              url: "mailto:tim@shi.ai",
            });
          }}
        >
          <svg
